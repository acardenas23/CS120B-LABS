...
#For this test, set PINA to 0x00 = 0000 0000 ->PORT B should be 0x00
#Next, set PINA to 0000 0001 = 0x01 ->PORTB should be 0x01
#3. Set PINA to 0010 = 0x02 ->PORTB should be 0x00
#4. SET PINA to 0011 = 0x03 ->PORT B should be 0x00
